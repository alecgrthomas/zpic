...
*   I have added functionality to load in complex and real arrays          *
...
int FFT (float data_re[], float data_im[], const unsigned long NVALS, int isign)
{
  ...
  if (test)
	...
	real part is data[index] and the complex part is data[index+1]
      */
      ...
      /*
	Pack components into float array of size n - the ordering 
